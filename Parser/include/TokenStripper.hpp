...
namespace TokenStripper {
    ...
    void stringToken(json& _outToken, const char* _code, int& _charPointer, int _linePointer) {
        ...
        int _quote = 39, _ascii = (int)_code[_charPointer], _backSlash = 92, _at = 64;
        ...
        do {
            ...
            // if((int)_code[_charPointer] == _at) {
            //     _formattings.push_back(stringFormatting(_outToken, _code, _charPointer, _linePointer));
            //     continue;
            // }
